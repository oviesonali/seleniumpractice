...
public class Vtiger extends SeleniumUtils{
	...
	public void getAppData() throws IOException {
		appUrl=readTestData(".\\ExcelData\\ReadData2.xlsx", "LoginDetails", 1,0);
		userName=readTestData(".\\ExcelData\\ReadData2.xlsx", "LoginDetails", 1,1);
		password=readTestData(".\\ExcelData\\ReadData2.xlsx", "LoginDetails", 1,2);
		expectedTitle=readTestData(".\\ExcelData\\ReadData2.xlsx", "LoginDetails", 1,3);
	}
	@BeforeMethod
	public void setUp() {
	...
	public void testPosition() {
		WebElement urName=driver.findElement(By.id("username"));
